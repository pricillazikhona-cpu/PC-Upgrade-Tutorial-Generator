...
const LoadingSpinner: React.FC = () => {
  const messages = [
    ...
    "Planning the optimal upgrade path...",
    "Consulting with virtual PC building experts...",
  ...
  return (
    <div className="flex flex-col items-center justify-center h-full text-center text-gray-400 animate-fade-in">
      ...
      <p className="text-lg font-semibold">Generating Your Guide</p>
      <p className="text-sm transition-opacity duration-500">{message}</p>
    </div>
  );
};
